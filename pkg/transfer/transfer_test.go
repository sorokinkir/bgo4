...
func TestService_Card2Card(t *testing.T) {
	...
	cardSvc.Add(
		&card.Card{
			ID:      1,
			Balance: 500,
			Number:  "5106 2100 0000 0001",
		},
		&card.Card{
			ID:      2,
			Balance: 400,
			Number:  "5106 2100 0000 0002",
		},
		&card.Card{
			ID:      3,
			Balance: 300,
			Number:  "5106 2100 0000 0003",
		},
		&card.Card{
			ID:      4,
			Balance: 100,
			Number:  "5106 2100 0000 0004",
		},
		&card.Card{
			ID:      5,
			Balance: 0,
	...
	tests := []struct {
	...
	}{
		{
			...
			args:      args{from: "5106 2100 0000 0001", to: "5106 2100 0000 0002", amount: 100},
			wantTotal: 100,
			wantErr:   nil,
		},
		{
			...
			fields:    fields{CardSvc: cardSvc, Commission: 0.5, RubMin: 10},
			args:      args{from: "5106 2100 0000 0001", to: "5106 2100 0000 0002", amount: 600},
			wantTotal: 600,
		...
		},
		{
			...
			fields:    fields{CardSvc: cardSvc, Commission: 0.5, RubMin: 10},
			args:      args{from: "5106 2100 0000 0003", to: "0010", amount: 200},
			wantTotal: 201,
			wantErr:   nil,
		},
		{
			...
			fields:    fields{CardSvc: cardSvc, Commission: 0.5, RubMin: 10},
			args:      args{from: "5106 2100 0000 0004", to: "0011", amount: 200},
			wantTotal: 201,
